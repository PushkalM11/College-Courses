...
padded_sym_3 = interpolateSignal(symbols_3);
ifft_sym_3 = ifft(padded_sym_3, N2);
...
[alpha1, beta2, beta3, alpha4] = allocatePower(h1, h2, h3, h4, 'water_filling', N_monte_carlo);
