...
with open("/Users/pushkalmishra/Desktop/Semester 3/Devices Lab/Experiment 8/NgSpice Codes/OR_Gate.txt") as datafile:
...
plt.title("Vout vs Time for OR Gate", fontdict={"font": "serif", "size": 25, "color": "black"})
