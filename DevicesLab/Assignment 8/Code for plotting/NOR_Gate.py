...
with open("/Users/pushkalmishra/Desktop/Semester 3/Devices Lab/Experiment 8/NgSpice Codes/NOR_Gate.txt") as datafile:
...
plt.title("Vout vs Time for NOR Gate", fontdict={"font": "serif", "size": 25, "color": "black"})
