...
with open("/Users/pushkalmishra/Desktop/Semester 3/Devices Lab/Experiment 8/NgSpice Codes/XOR_Gate.txt") as datafile:
...
plt.title("Vout vs Time for XOR Gate", fontdict={"font": "serif", "size": 25, "color": "black"})
